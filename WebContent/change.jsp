...
<body>
	<center>
		<table>
			<tr>
				<td><h2>Forget Password Form</h2></td>
			</tr>
			...
			<form action="change1.jsp">
				...
				<tr>
                 ...
                 <tr>
					<td><label for="psw"><b> enter old Password</b></label></td>
				</tr>
                <tr>
				    <td><input type="text" placeholder="Enter old Password" name="opass"
					required></td>
			    </tr>
                
				<tr>
					<td><label for="psw"><b> enter new Password</b></label></td>
				</tr>
			<tr>
				<td><input type="text" placeholder="Enter Password" name="pass"
					required></td>
			</tr>

			<tr>
				<td><label for="psw"><b>Conform password Password</b></label></td>
			</tr>
